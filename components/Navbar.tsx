...
import { ShoppingCart, Activity, LogOut } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-18 items-center py-3">
          <div className="flex items-center gap-2.5 transition-transform active:scale-95 cursor-pointer select-none" onClick={handleLogoClick}>
            ...
            {isAdmin && (
              <span className="ml-2 px-2 py-1 bg-slate-900 text-white text-[10px] font-bold uppercase tracking-wider rounded-md shadow-md animate-fade-in">
                Admin
              </span>
            )}
          </div>
